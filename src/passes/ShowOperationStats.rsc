...
module passes::ShowOperationStats
...
public str NAME = "showOperationStats";
...
public PassData showOperationStats(PassData pd) {
	pd.ms += raw_passes::g_getOperationStats::ShowOperations::showOperations(pd.t);
	return pd;
}