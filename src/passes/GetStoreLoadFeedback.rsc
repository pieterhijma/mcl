...
module passes::GetStoreLoadFeedback
...
import raw_passes::g_storeLoadFeedback::ScarceMemory;


public str NAME = "getStoreLoadFeedback";
...
public PassData doGetStoreLoadFeedback(PassData pd) {
	pd.ms += getScarceMemFeedback(pd.t);
	return pd;
}