...
import raw_passes::g_getHDLFeedback::GetHDLFeedback;


public str NAME = "getHDLFeedback";
...
public PassData doGetHDLFeedback(PassData pd) {
	pd.ms += getHDLFeedback(pd.m, pd.t);
	return pd;
}