...
module passes::UnrollLoops



import PassData;

//import raw_passes::f_transform::UnrollLoops;
...
public PassData unrollLoops(PassData pd) {
	//pd.m =
	//	raw_passes::f_transform::UnrollLoops::unrollLoops(pd.m, pd.symbols);
	return pd;
}