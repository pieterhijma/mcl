...
module passes::GetMemoryFeedback
...
import raw_passes::g_memoryFeedback::GetMemoryFeedback;


public str NAME = "getMemoryFeedback";
...
public PassData doGetMemoryFeedback(PassData pd) {
	pd.ms += getMemoryFeedback(pd.t);
	return pd;
}