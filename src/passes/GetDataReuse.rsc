...
import raw_passes::g_getDataReuse::GetDataReuse;


public str NAME = "getDataReuse";
...
public PassData doGetDataReuse(PassData pd) {
	pd.ms += getDataReuse(pd.t);
	return pd;
}