...
module passes::InlineFunctionParameters
...
import raw_passes::g_transform::InlineFunctionParameters;


public str NAME = "inlineFunctionParameters";
...
public PassData inlineFunctionParameters(PassData pd) {
	<pd.m, pd.t> = inline(pd.m, pd.t);
