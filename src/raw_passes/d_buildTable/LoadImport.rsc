...
module raw_passes::d_buildTable::LoadImport
...
public tuple[map[str, HDLDescription], list[Message]] loadImport(Identifier id) {
	map[str, HDLDescription] hwDescs = convertHWDescr(id.string);
